f=open("argomenti/file/biblioteca/biblioteca/Moby Dick.txt", encoding="utf-8") # il punto (.) è il percorso attuale, i due punti(..) per il percorso precedente all'attuale,se uso slash verso sinistra bisogna raddoppiarlo (\\) invece se uso lo slash a destra (/)
